...
class JlinkProbe(DebugProbe):
    ...
    def connect(self, protocol=None):
        self._link.enter_debug(JLink.Protocol.SWD)
    ...
    def read_dp(self, addr, now=True):
        result = self._link.read_dap_register(JLink.DP_PORT, addr)
    ...
    def write_dp(self, addr, data):
        result = self._link.write_dap_register(JLink.DP_PORT, addr, data)
